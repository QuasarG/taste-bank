...
// ---------- ASCII Logo ----------
// "TASTE BANK" figlet Standard 字体（5 行，57 字符宽，80 列终端稳放下）
const LOGO_LINES = [
  '  _____  _    ____ _____ _____   ____    _    _   _ _  __',
  ' |_   _|/ \\  / ___|_   _| ____| | __ )  / \\  | \\ | | |/ /',
  '   | | / _ \\ \\___ \\ | | |  _|   |  _ \\ / _ \\ |  \\| | \' /',
  '   | |/ ___ \\ ___) || | | |___  | |_) / ___ \\| |\\  | . \\',
  '   |_/_/   \\_\\____/ |_| |_____| |____/_/   \\_\\_| \\_|_|\\_\\',
];

// 渐变色 logo：每行用不同色
const LOGO_GRADIENT = [c.brightMagenta, c.magenta, c.brightBlue, c.cyan, c.brightCyan];
